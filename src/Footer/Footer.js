    ...
    return(
        <footer className="footer">
            <ul className="footer-link-list">
                <li className="footer-link-item"><a href="#"><img src="./Assets/Imgs/download_icon.svg" alt="download lookbook icon"/><span>Lookbook</span></a></li>
                <li className="footer-link-item"><a href="#">Regulamin</a></li>
                <li className="footer-link-item"><a href="#">Kontakt</a></li>
            </ul>
            <ul className="footer-link-list">
